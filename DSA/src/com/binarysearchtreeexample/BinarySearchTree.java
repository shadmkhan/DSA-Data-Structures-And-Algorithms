...
public class BinarySearchTree<T extends Comparable<T>> {
	...
	public String printTreePostOrder2()
	{
		return traverseTreePostOrder2(root);
	}
	...
	public HashMap<String, Node> seen = new HashMap<>();
	
	private String traverseTreePostOrder2(Node<T> r)
	{
		if(r==null) return "N";		
		String left = traverseTreePostOrder2(r.getLeft());
		String right = traverseTreePostOrder2(r.getRight());
		String signature = left + " : " + r.getData() + " : "+ right;
		System.out.println(signature);
		seen.put(signature, r);
		return signature;
		//System.out.print( r.getData().toString()+ ",");
	}
